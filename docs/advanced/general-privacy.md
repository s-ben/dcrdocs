...
It's also important to note, that different wallets might use different [address types](address-details.md). This can also give a hint about your identity, which combined with other signals can ultimately reveal your identity.
